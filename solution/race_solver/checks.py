...
def run_self_checks() -> None:
    ...
    medium_cool_fast_mid_race = RaceConfig("MediumCoolFastMid", 45, 87.5, 22.5, 18)
    medium_high_pit_race = RaceConfig("MediumHighPit", 45, 87.5, 22.5, 30)
    medium_cool_slow_cool_race = RaceConfig("MediumCoolSlowCool", 63, 91.0, 21.0, 24)
    ...
    assert runtime_fallback_context_key("medium_cool_fast_mid") == "medium_high_pit"
    ...
    assert runtime_model_for_config(medium_cool_fast_mid_race) != runtime_model_for_config(medium_high_pit_race)
